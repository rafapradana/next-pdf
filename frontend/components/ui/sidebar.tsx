...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "p-2 relative flex w-full min-w-0 flex-col overflow-hidden",
        className
      )}
      {...props}
    />
...
function SidebarGroupContent({
  ...
  return (
    <div
      ...
      className={cn("text-sm w-full min-w-0 overflow-hidden", className)}
      {...props}
    />
  )
}
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("gap-1 flex w-full min-w-0 flex-col overflow-hidden", className)}
      {...props}
    />
  )
}
